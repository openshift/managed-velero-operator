...
- `managed-velero-operator-pull-request.yaml`: PR validation
- `managed-velero-operator-push.yaml`: Main branch builds
- `managed-velero-operator-pko-pull-request.yaml`: PKO validation
- `managed-velero-operator-pko-push.yaml`: PKO deployment
...
# tkn pipeline validate -f .tekton/managed-velero-operator-pull-request.yaml
...
```text
CI Status: FAILING
Pipeline: managed-velero-operator-pull-request
Stage: golangci-lint
Error: Exit code 1
