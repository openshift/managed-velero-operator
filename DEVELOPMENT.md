...
Quick reference for developing the Managed Velero.
...
```bash
# Clone repository
git clone https://github.com/openshift/managed-velero-operator.git
cd managed-velero-operator
...
go test ./controllers/velero/...  # Test specific package
...
```bash
# Run specific test
ginkgo -focus="NetworkPolicy" ./controllers/velero/

# Run tests for one package
go test -v ./controllers/velero/
...
- **Controllers**: `controllers/velero/` - Reconciliation logic
- **Business Logic**: `controllers/velero/` - Resource management
