...
require (
	...
	github.com/openshift/api v0.0.0-20260527180537-d6ce07951593 // release-4.13
	github.com/openshift/cloud-credential-operator v0.0.0-20260520203253-833d9a3e986b // release-4.13
