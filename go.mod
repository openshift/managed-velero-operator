...
require (
	...
	github.com/openshift/api v0.0.0-20220502162600-a191b4bb80cc
...
replace ( //required by velero
	...
	github.com/operator-framework/operator-lib => github.com/operator-framework/operator-lib v0.9.0
