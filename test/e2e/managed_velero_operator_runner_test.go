...
const (
	...
	jUnitOutputFilename  = "junit-managed-velero-operator.xml"
)

// Test entrypoint. osde2e runs this as a test suite on test pod.
func TestManagedVeleroOperator(t *testing.T) {
	...
	RunSpecs(t, "Managed Velero Operator", suiteConfig, reporterConfig)
}
